...
logging.basicConfig(level=logging.INFO, format='%(asctime)s [ %(levelname)s ] :: %(message)s',
    ...
    handlers.RotatingFileHandler(f'AllPapua.log'),
...
class Kpu():
    ...
    def get_banyak(self):
        with ThreadPoolExecutor() as executor:
            executor.map(self.get_detail_by_province, [Province.PAPUA, Province.PAPUA_BARAT, Province.PAPUA_BARAT_DAYA, Province.PAPUA_PEGUNUNGAN, Province.PAPUA_SELATAN, Province.PAPUA_TENGAH])
